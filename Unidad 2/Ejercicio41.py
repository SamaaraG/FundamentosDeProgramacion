...
class Alumno:
    #El atributo alumno estara representando a cada uno de los estudiantes para 
    #recolectar y ordenar los datos necesarios. Tipo Cadena.
...
class Universidad:
    #Universidad se alimentara de datos de alumnos y profesores, clasificandolos en carreras y materias, respectivamente.
    #Tipo Cadena
...
class Carrera:
    #La carrera determinara las materias impartidas
    #Tipo cadena
    def __init__(self, nombre: str):
        self.nombre = nombre
...
class Materia:
    #La materia deternimara la calificacion de cada alumno
    #Tipo cadena, calificacion de tipo entero
...
class Profesor:
    #Se utilizara para registrar a cada uno de los profesores y se relacionara con el atributo materia.
    #De tipo Cadena
